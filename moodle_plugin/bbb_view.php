...
echo '<html><head><title>Kapatılıyor...</title></head><body style="background:#f4f4f5; display:flex; justify-content:center; align-items:center; height:100vh; margin:0; font-family:sans-serif; color:#6b7280;">';
echo '<div>Oturum kapatıldı, bu sekme otomatik olarak kapanacaktır...</div>';
